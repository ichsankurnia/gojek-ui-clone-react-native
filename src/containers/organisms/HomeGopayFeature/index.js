        ...
        return (
            <View style={{marginHorizontal:13}}>
                <View style={{flexDirection:'row', justifyContent:'space-between', backgroundColor:'#2C5FB8', borderTopLeftRadius:6, borderTopRightRadius:6, paddingHorizontal:14, paddingVertical:10}}>
                    ...
                    <Text style={{color:'#FFF', fontSize:17, fontWeight: 'bold', }}>Rp0</Text>
                </View>
                <View style={{flexDirection:'row', backgroundColor:'#2F65BD', paddingTop:13, paddingBottom:12, borderBottomLeftRadius:6, borderBottomRightRadius:6}}>
